...
def test_job_key_requirements_instantiation():
    ...
    assert instance.key_skills == data["key_skills"]
    assert instance.candidate_priorities == data["candidate_priorities"]
...
def test_candidate_analysis_instantiation():
    ...
    data = {
        "skill_summary": {
            ...
            "FastAPI": "demonstrated experience",
        }
    }
    instance = CandidateAnalysis(**data)
    assert instance.skill_summary == data["skill_summary"]
...
def test_generated_introduction_instantiation():
    ...
    assert instance.introduction == data["introduction"]
